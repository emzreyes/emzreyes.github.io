...
import TreadmillExercise from './components/TreadmillExercise';
...
const TREADMILL_EXERCISE = 'treadmill'
...
let exerciseList = [
  ...
  {type: REPETITION_EXERCISE, name: "Burpees"},
  {type: TREADMILL_EXERCISE, name: "Treadmill Stat Recorder"},
  {type: TREADMILL_EXERCISE, name: "Treadmill Incline Stat Recorder"}
]
  ...
  if(currentScreen === MENU_SCREEN) {
    ...
    switch(currentExercise.type) {
      ...
      case REPETITION_EXERCISE:
        ...
        />
      break;
      case TREADMILL_EXERCISE:
        screenComponent = <TreadmillExercise 
          exercise={currentExercise}
          setMenuScreen={()=>setCurrentScreen(MENU_SCREEN)} 
        />
      break;
